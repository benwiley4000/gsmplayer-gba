...
void initArt()
{
    ...
    OAM[64].attr0 |= OBJ_Y(reelAnimationY) | ATTR0_COLOR_256 | ATTR0_SQUARE | ATTR0_ROTSCALE;
    OAM[64].attr1 = OBJ_X(reelAnimationX) | ATTR1_SIZE_32;
    OAM[64].attr2 = (0x3FF & ((0 + reel_tile_offset) * tile_block_size));
    // Reel 2
    OAM[65].attr0 |= OBJ_Y(reelAnimationY) | ATTR0_COLOR_256 | ATTR0_SQUARE | ATTR0_ROTSCALE;
    OAM[65].attr1 = OBJ_X(reelAnimationX + 36) | ATTR1_SIZE_32;
    OAM[65].attr2 = (0x3FF & ((0 + reel_tile_offset) * tile_block_size));
    // Tape 1
    OAM[66].attr0 |= OBJ_Y(reelAnimationY) | ATTR0_COLOR_256 | ATTR0_SQUARE;
    OAM[66].attr1 = OBJ_X(reelAnimationX + 15) | ATTR1_SIZE_32;
    OAM[66].attr2 = (0x3FF & ((1 + reel_tile_offset) * tile_block_size));
    // Tape 2 (overlaps)
    OAM[67].attr0 |= OBJ_Y(reelAnimationY) | ATTR0_COLOR_256 | ATTR0_SQUARE;
    OAM[67].attr1 = OBJ_X(reelAnimationX + 17) | ATTR1_SIZE_32;
    OAM[67].attr2 = (0x3FF & ((1 + reel_tile_offset) * tile_block_size));
}
...
void drawArt(GsmPlaybackTracker *playback)
{
    ...
    for (u16 i = 64; i < 66; i++) {
        ...
        affineSrc.sX = 0x100;
        affineSrc.sY = 0x100;
        affineSrc.theta = playback->reel_rotation_theta;
